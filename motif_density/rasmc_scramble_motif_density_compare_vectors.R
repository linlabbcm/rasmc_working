...
dim(signal_table)
density_table = read.delim('/storage/cylin/grail/projects/rasmc_all/motif_density/scramble_seq_density_from_fasta_full_length.txt',header=TRUE)
dim(density_table)
density_table[1:5,]
...
write.table(compare_table,'/storage/cylin/grail/projects/rasmc_all/motif_density/subpeak_to_region_scramble_motif_density_table.txt',row.names=FALSE,col.names=TRUE,quote=FALSE,sep='\t')

#example
#pdf(file = "/storage/cylin/grail/projects/rasmc_all/figures/compare_vectors_log2brd4_24v0_scramble_motif_density.pdf")
...
#example
#pdf(file = "/storage/cylin/grail/projects/rasmc_all/figures/compare_vectors_log2brd4_scramble_2v0_motif_density.pdf")
v2 = compare_table$`MOTIFS/KB`
...
pdf(file = "/storage/cylin/grail/projects/rasmc_all/figures/compare_vectors_log2brd4_24v2_scramble_motif_density.pdf")
v2 = compare_table$`MOTIFS/KB`
v1 = log2(mean_24h/mean_2h)

compareVectors(v1,v2,'brd4 24_v_2','NHR motif density','Log2 Fold Change in 24H v 2H Brd4 versus motif density')
dev.off()
...
density_JF = read.delim('/storage/cylin/grail/projects/rasmc_all/motif_density/scramble_seq_density_from_fasta_full_length_jun_fos.txt',header=TRUE)
dim(density_JF)
density_JF[1:5,]

compare_table_JF = cbind(region_table[,1:4],region_map[,1],density_JF[,1]*1000,round(density_JF[,1]*density_JF[3]),density_JF[,2:3],mean_unstim,mean_2h,mean_24h,log2(mean_2h/mean_unstim),log2(mean_24h/mean_unstim))
...
compare_table_JF[1:5,]

write.table(compare_table_JF,'/storage/cylin/grail/projects/rasmc_all/motif_density/subpeak_to_region_scramble_motif_density_table_JF.txt',row.names=FALSE,col.names=TRUE,quote=FALSE,sep='\t')


#pdf(file = "/storage/cylin/grail/projects/rasmc_all/figures/compare_vectors_log2brd4_24v0_scramble_motif_density_JF.pdf")
v2 = compare_table_JF$`MOTIFS/KB`
v1 = compare_table_JF$LOG2FC_24v0

#compareVectors(v1,v2,'brd4 24_v_0','JF motif density','Log2 Fold Change in 24H Brd4 versus motif density')
#dev.off()




#pdf(file = "/storage/cylin/grail/projects/rasmc_all/figures/compare_vectors_log2brd4_scramble_2v0_motif_density_JF.pdf")
v2 = compare_table_JF$`MOTIFS/KB`
v1 = compare_table_JF$LOG2FC_2v0

#compareVectors(v1,v2,'brd4 2_v_0','JF motif density','Log2 Fold Change in 2H Brd4 versus motif density')
#dev.off()


#pdf(file = "/storage/cylin/grail/projects/rasmc_all/figures/compare_vectors_log2brd4_scramble_2v24_motif_density_JF.pdf")
v2 = compare_table_JF$`MOTIFS/KB`
v1 = log2(mean_24h/mean_2h)

#compareVectors(v1,v2,'brd4 2_v_0','JF motif density','Log2 Fold Change in 2H versus 24 Brd4 versus motif density')
#dev.off()