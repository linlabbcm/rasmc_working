...
#NHR scramble table
#table_path='/storage/cylin/grail/projects/rasmc_all/motif_density/scramble_seq_density_from_fasta_full_length.txt'

#Jun/Fos scramble table
table_path='/storage/cylin/grail/projects/rasmc_all/motif_density/scramble_seq_density_from_fasta_full_length_jun_fos.txt'
