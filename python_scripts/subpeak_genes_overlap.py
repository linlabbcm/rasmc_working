...
subpeak_signal_path = '/storage/cylin/grail/projects/rasmc_all/signalTables/rasmc_h3k27ac_0_tss_subpeak_Brd4_signal_table.txt'

subpeak_signal = utils.parseTable(subpeak_signal_path,'\t')
...
for line in subpeak_signal[1:]:
	...
	new_line = [gene_string,line[1],line[2],line[3],line[4],line[5],line[6],line[7],line[8],line[9],line[10],line[11],line[12],line[13]]
	overlap_table.append(new_line)

utils.unParseTable(overlap_table,'/storage/cylin/grail/projects/rasmc_all/TF_Network/subpeak_genes_signal_table.txt','\t')
